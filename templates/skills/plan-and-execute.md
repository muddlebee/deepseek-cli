...
The toggle should be placed in the settings page.
```
...
**Example requirements:**
```markdown
# Bug fix: Login form crashes on submit

The app crashes when the user clicks submit.
